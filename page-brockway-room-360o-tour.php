...
pano.readConfigUrl("<?php bloginfo('template_url'); ?>/360tour/brockway-room/assets/html5/tour.xml");
</script>
<noscript>
...
<?php } ?>
		<p><div class="medium secondary btn"><a href="/venue-hire/brockway-room/">&laquo; Back</a></div></p>
	</div>
