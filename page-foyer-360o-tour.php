...
pano.readConfigUrl("<?php bloginfo('template_url'); ?>/360tour/foyer-1/assets/html5/tour.xml");
</script>
<noscript>
...
<?php } ?>
		<p><div class="medium secondary btn"><a href="/venue-hire/foyer-1/">&laquo; Back</a></div></p>
	</div>
