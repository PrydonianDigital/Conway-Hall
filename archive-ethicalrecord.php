...
<div class="row">
	...
	<h2>Ethical Record <div class="alignright"><a href="/ethicalrecord/feed/"><i class="icon-rss"></i></a></div></h2>
		<?php
				...
				<div class="row article">
					<div <?php post_class('twelve columns'); ?>>
		    			...
		    			<?php global $post; $video = get_post_meta( $post->ID, '_cmb_video', true ); if( $video != '' ) :  ?>
							<?php echo apply_filters( 'the_content', get_post_meta( get_the_ID(), '_cmb_video', true ) );  ?>
						<?php endif; ?>
					</div>
				</div>
				<?php endwhile; ?>
