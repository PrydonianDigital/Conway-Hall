...
pano.readConfigUrl("<?php bloginfo('template_url'); ?>/360tour/library/assets/html5/tour.xml");
</script>
<noscript>
...
<?php } ?>
		<p><div class="medium secondary btn"><a href="/venue-hire/library/">&laquo; Back</a></div></p>
	</div>
