...
pano.readConfigUrl("<?php bloginfo('template_url'); ?>/360tour/foyer-2/assets/html5/tour.xml");
</script>
<noscript>
...
<?php } else { ?>	
		...
		<div id="foyeropen360" class="pano">
...
<?php } ?>
		<p><div class="medium secondary btn"><a href="/venue-hire/foyer-2/">&laquo; Back</a></div></p>
	</div>
