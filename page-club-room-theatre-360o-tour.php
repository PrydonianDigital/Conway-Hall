...
pano.readConfigUrl("<?php bloginfo('template_url'); ?>/360tour/club-room-2/assets/html5/tour.xml");
</script>
<noscript>
...
<?php } ?>
		<p><div class="medium secondary btn"><a href="/venue-hire/club-room-2/">&laquo; Back</a></div></p>
	</div>
