...
pano.readConfigUrl("<?php bloginfo('template_url'); ?>/360tour/main-hall/assets/html5/tour.xml");
</script>
<noscript>
...
<?php } ?>
		<p><div class="medium secondary btn"><a href="/venue-hire/main-hall/">&laquo; Back</a></div></p>
	</div>
