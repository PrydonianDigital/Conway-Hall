...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://wordpress_5:hD!2Nf9n7K@localhost:3306/wordpress_1?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://wordpress_5:hD!2Nf9n7K@localhost:3306/wordpress_1?new_link=true' );
}
...
$civicrm_root = '/var/www/vhosts/conwayhalltemp.org.uk/httpdocs/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/vhosts/conwayhalltemp.org.uk/httpdocs/wp-content/plugins/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://conwayhalltemp.org.uk/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'a3d9a96ac110a602eabfc2d807eb4cdd' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/vhosts/conwayhalltemp.org.uk/httpdocs/wp-content/plugins/files/civicrm/templates_c//mail.log' );
// }
