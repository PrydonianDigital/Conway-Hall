		...
		<div class="row">
			<div class="twelve columns">
				...
				<form role="search" method="get" class="searchform group" action="<?php echo home_url( '/' ); ?>">
					...
					<p>If you want to search our extensive document library which includes the Ethical Record, please use our dedicated <strong><a href="/pdf-search/?docsearch=<?php echo get_search_query(); ?>">PDF Search</a></strong> page.</p>
				</form>
