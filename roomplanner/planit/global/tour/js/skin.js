...
// Generated Tue 20. Sep 19:20:19 2011
...
function pano2vrSkin(player,skinlayer,base) {
	...
	this.addSkin=function() {
		...
		this._image_5__img.setAttribute('src',basePath + '../buttons/image-5.png');
		...
		this._button_4__img.setAttribute('src',basePath + '../buttons/button-4.png');
		...
		this._button_4.onmouseover=function () {
			me._button_4__img.src=basePath + '../buttons/button-4-o.png';
		}
		this._button_4.onmouseout=function () {
			me._button_4__img.src=basePath + '../buttons/button-4.png';
		}
		...
		this._button_2__img.setAttribute('src',basePath + '../buttons/button-2.png');
		...
		this._button_2.onmouseover=function () {
			me._button_2__img.src=basePath + '../buttons/button-2-o.png';
		}
		this._button_2.onmouseout=function () {
			me._button_2__img.src=basePath + '../buttons/button-2.png';
		}
		...
		this._button_1__img.setAttribute('src',basePath + '../buttons/button-1.png');
		...
		this._button_1.onmouseover=function () {
			me._button_1__img.src=basePath + '../buttons/button-1-o.png';
		}
		this._button_1.onmouseout=function () {
			me._button_1__img.src=basePath + '../buttons/button-1.png';
		}
		...
		this._button_3__img.setAttribute('src',basePath + '../buttons/button-5.png');
		...
		this._button_3.onmouseover=function () {
			me._button_3__img.src=basePath + '../buttons/button-5-o.png';
		}
		this._button_3.onmouseout=function () {
			me._button_3__img.src=basePath + '../buttons/button-5.png';
		}
