...
pano.readConfigUrl("<?php bloginfo('template_url'); ?>/360tour/club-room-1/assets/html5/tour.xml");
</script>
<noscript>
...
<?php } else { ?>	
		...
		<div id="clubsquare360" class="pano">
...
<?php } ?>
		<p><div class="medium secondary btn"><a href="/venue-hire/club-room-1/">&laquo; Back</a></div></p>
	</div>
